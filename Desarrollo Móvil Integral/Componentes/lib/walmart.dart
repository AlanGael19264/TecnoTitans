...
class WalmartPage extends StatefulWidget {
  const WalmartPage({super.key});

  @override
  _WalmartPageState createState() => _WalmartPageState();
}

class _WalmartPageState extends State<WalmartPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Imagen de Walmart
            Image.asset(
              "assets/walmart.jpg", // Aquí va tu imagen de Walmart
              width: 356,
              height: 205,
              fit: BoxFit.cover,
            ),
            ...
            Image.asset(
              "assets/map_walmart.jpg", // Cambiar por la imagen correspondiente al mapa de Walmart
              width: 310,
              height: 214,
              fit: BoxFit.cover,
            ),
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 10),
                const Text(
                  "+528009256278", // Número de contacto de Walmart
                  style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w400,
                  ),
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 10),
                const Text(
                  "https://www.walmart.com.mx/", // URL de Walmart
                  style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w400,
                    color: Colors.blue,
